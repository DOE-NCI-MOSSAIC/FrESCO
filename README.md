...
Documentation is available over at [Read the Docs](https://doe-nci-fresco.readthedocs.io/en/latest/), and a software archive at Zenodo [![DOI](https://zenodo.org/badge/639999591.svg)](https://zenodo.org/badge/latestdoi/639999591).
...
The machinery provied here is designed to work with neural network models, and is overkill for a traditional sklearn type
...
the sklearn library, which expects feature vectors as input, not higher dimensional, ie matrix nor tensor, inputs. 

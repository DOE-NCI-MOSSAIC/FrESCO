...
cd /mnt/nci/scratch/gounleyj.nci/model_suite_v2/tests/end_to_end/ie_ntask

srun python ../../../train_model.py -m ie -args /mnt/nci/scratch/gounleyj.nci/model_suite_v2/tests/end_to_end/ie_ntask
